...
import { CheckCircle, ShieldCheck, Mail, Briefcase, Award, Heart, Smile, X } from 'lucide-react';
    ...
    <div className="pt-28 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="text-center max-w-xl mx-auto mb-12">
          <h2 className="text-2xl font-poppins font-bold text-dark dark:text-light mb-2">Employee Benefits</h2>
          <p className="text-xs text-dark/60 dark:text-light/60">We support our talent with modern gear, continuing learning stipends, and healthy workflows.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((b, idx) => (
            <div key={idx} className="p-6 rounded-2xl glass-panel border border-light/25 dark:border-white/5 flex gap-4">
      ...
      {/* 3. Job Listings */}
      <section className="max-w-4xl mx-auto px-6 py-12 flex flex-col gap-6">
        <div className="text-center max-w-xl mx-auto mb-10">
          <h2 className="text-2xl font-poppins font-bold text-dark dark:text-light mb-2">Open Positions</h2>
          <p className="text-xs text-dark/60 dark:text-light/60">Browse active opportunities below. Click to read specifications and apply.</p>
        </div>
