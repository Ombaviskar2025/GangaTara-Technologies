          ...
          {caseStudiesData.map((cs, index) => (
            ...
            >
              <div className="h-full rounded-2xl glass-card border border-light/20 dark:border-white/5 hover:border-primary/25 flex flex-col overflow-hidden">
                {/* Styled Vector Header instead of broken local images */}
                <div className="w-full h-44 bg-gradient-to-tr from-primary/10 to-secondary/20 flex items-center justify-center p-6 border-b border-light/10 dark:border-white/5 relative">
                  <div className="absolute inset-0 bg-slate-900/10 dark:bg-slate-900/40 mix-blend-multiply" />
                  <Trophy className="w-12 h-12 text-primary dark:text-secondary group-hover:scale-110 transition-transform duration-300" />
