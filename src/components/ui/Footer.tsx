      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2.5 text-xs text-white/50 border-t border-white/5 pt-4">
              <span className="flex items-center gap-2"><MapPin className="w-3.5 h-3.5 text-primary" /> EMEA HQ: Munich, Germany | APAC HQ: Pune, India</span>
              <span className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-primary" /> +91 9009494056 / +49 (89) 555-0199</span>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/40">
          <p className="flex items-center gap-1">
            ...
            <span className="hidden sm:inline">| Made with <Heart className="w-3 h-3 text-red-500 fill-current inline" /> by GangaTara Technologies</span>
          </p>
