      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 bg-[#0B1120]/85 z-[70] backdrop-blur-sm"
            onClick={handleClose}
          />
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-[8vh] bottom-[8vh] sm:inset-auto sm:left-1/2 sm:-translate-x-1/2 sm:top-[8vh] sm:w-[680px] sm:max-h-[84vh] z-[75] flex flex-col rounded-2xl overflow-hidden bg-[#0D1526] border border-white/10 shadow-2xl shadow-black/60"
            role="dialog"
            aria-modal="true"
